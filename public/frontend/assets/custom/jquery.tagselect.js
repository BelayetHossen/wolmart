      ...
      this.tagselect = {
            ...
            if ($(el).is('optgroup')) {
              $(el).children().each(function(index, subel) {
                ...
                if ($(subel).attr('selected')) {
                  selectOpt.push('<li class="qtagselect__choice ' + _class + '" data-cid="' + id + '"><span>' + $(subel).text() + '</span><a class="qtagselect__del"><span class="qtagselect_del_cross">&times;</span></a></li>');
                }
              })
            } else {
              if ($(el).attr('selected')) {
                selectOpt.push('<li class="qtagselect__choice ' + _class + '" data-cid="' + id + '"><span>' + $(el).text() + '</span><a class="qtagselect__del"><span class="qtagselect_del_cross">&times;</span></a></li>');
              }
            }
          })
        ...
        showOpt: function(e) {
          ...
          if (ul.find('.qtagselect__choice').length < settings.maxTag) {
            ...
            ul.append('<li class="qtagselect__choice ' + _class + '" data-cid="' + _this.attr("data-rid") + '"><span>' + _this.html() + '</span><a class="qtagselect__del"><span class="qtagselect_del_cross">&times;</span></a></li>');
