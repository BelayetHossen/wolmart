 @php
    ...
    if (Auth::guard('customer')->check()) {
        $customeroption = '<a href="'.route('customer.dashboard').'" class="d-lg-show">My Dashboard</a><a href="'.route('customer.logout').'" class="d-lg-show">Logout</a>';
    ...
    if (Auth::guard('vendor')->check()) {
        $vendoroption = '<a href="'.route('vendor.dashboard').'" class="d-lg-show">My dashboard</a><a href="'.route('vendor.logout').'" class="d-lg-show">Logout</a>';
        $customeroption = '';
    }
    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="dropdown">
                    <a href="#language"><img src="{{asset('')}}frontend/assets/images/flags/eng.png" alt="ENG Flag" width="14" height="8" class="dropdown-image" /> ENG</a>
                    <div class="dropdown-box">
                        <a href="#ENG">
                        ...
                        <a href="#FRA">
                            <img src="{{asset('')}}frontend/assets/images/flags/fra.png" alt="FRA Flag" width="14" height="8" class="dropdown-image" />
                            FRA
                        </a>
                    </div>
                </div>
            ...
            <div class="header-right ml-4">
                <div class="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div class="call-info d-lg-show">
                        <h4 class="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0"><a href="mailto:#" class="text-capitalize">Live Chat</a> or :</h4>
                    ...
                    {{-- <div class="dropdown category-dropdown has-border" data-visible="true">
                        ...
                        <div class="dropdown-box">
                            <ul class="menu vertical-menu category-menu">
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="banner-fixed menu-banner menu-banner2">
                                                <figure>
                                                    <img src="{{asset('')}}frontend/assets/images/menu/banner-2.jpg" alt="Menu Banner" width="235" height="347" />
                                                </figure>
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                <figure>
                                                    <img src="{{asset('')}}frontend/assets/images/menu/banner-3.jpg" alt="Menu Banner" width="235" height="461" />
                                                </figure>
                                                <div class="banner-content">
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                <figure>
                                                    <img src="{{asset('')}}frontend/assets/images/menu/banner-4.jpg" alt="Menu Banner" width="235" height="433" />
                                                </figure>
                                                <div class="banner-content">
                                        ...
                                        <li class="row">
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{asset('')}}frontend/assets/images/menu/banner-5.jpg" alt="Banner" width="410" height="123" style="background-color: #d2d2d2;" />
                                                    </figure>
                                            ...
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{asset('')}}frontend/assets/images/menu/banner-6.jpg" alt="Banner" width="410" height="123" style="background-color: #9f9888;" />
                                                    </figure>
                                ...
                                <li>
                                    <a href="shop-fullwidth-banner.html"> <i class="w-icon-camera"></i>Cameras & Photo </a>
                                </li>
                                <li>
