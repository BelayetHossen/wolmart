<html lang="en" class="wf-poppins-n4-active wf-poppins-n7-active wf-poppins-n6-active wf-poppins-n5-active wf-active">
<!-- Mirrored from portotheme.com/html/wolmart/shop-banner-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jan 2022 07:32:43 GMT -->
...
<body class="loaded">
    <div class="page-wrapper">
        ...
        $customeroption = '<a href="'.route('customer.dashboard').'" class="d-lg-show">My Dashboard</a><a
            href="'.route('customer.logout').'" class="d-lg-show">Logout</a>';
        $vendoroption = '<a href="'.route('vendor.register').'" class="d-lg-show">Apply to sell</a>';
        } else {
        $customeroption = '<a href="#" class="d-lg-show login_btn"><i class="w-icon-account"></i>Sign In</a>
        <span class="delimiter d-lg-show">/</span>
        <a href="'.route('customer.register').'" style="margin-left: -1px;">Register</a>';
        $vendoroption = '<a href="'.route('vendor.dashboard').'" class="d-lg-show">Sell to us</a>';
        }

        if (Auth::guard('vendor')->check()) {
        $vendoroption = '<a href="'.route('vendor.dashboard').'" class="d-lg-show">My dashboard</a><a
            href="'.route('vendor.logout').'" class="d-lg-show">Logout</a>';
        $customeroption = '';
        }
            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown">
                            <a href="#language"><img src="{{asset('')}}frontend/assets/images/flags/eng.png"
                                    alt="ENG Flag" width="14" height="8" class="dropdown-image" /> ENG</a>
                            <div class="dropdown-box">
                                <a href="#ENG">
                                    <img src="{{asset('')}}frontend/assets/images/flags/eng.png" alt="ENG Flag"
                                        width="14" height="8" class="dropdown-image" />
                                    ENG
                                </a>
                                <a href="#FRA">
                                    <img src="{{asset('')}}frontend/assets/images/flags/fra.png" alt="FRA Flag"
                                        width="14" height="8" class="dropdown-image" />
                                    FRA
                                </a>
                            </div>
                        ...
                        {!! htmlspecialchars_decode($vendoroption) !!}
                        {!! htmlspecialchars_decode($customeroption) !!}
                    </div>
                </div>
            </div>
            <!-- End of Header Top -->
                ...
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="demo1.html" class="logo ml-lg-0">
                            <img src="{{asset('')}}frontend/assets/images/logo.png" alt="logo" width="144"
                                height="45" />
                        </a>
                    ...
                    <div class="header-right ml-4">
                        ...
                        <div class="dropdown cart-dropdown cart-offcanvas mr-0 mr-lg-2">
                            ...
                            {{-- mini cart --}}
                            <div class="dropdown-box mini-cart-content">
                        ...
                        <div class="header-left">
                            ...
                            <nav class="main-nav">
                                <ul class="menu active-underline">
                                    ...
                                    <li>
                                        <a href="{{ route('vendor.index') }}">Agents</a>
                                    </li>
                                    <li>
                    ...
                    {{-- <div class="col-md-3">
                        <div class="category_box">
                            <ul class="menu vertical-menu category-menu">
                                ...
                                <li class="has-submenu">
                                    <a href="shop-fullwidth-banner.html"> <i class="w-icon-home"></i>Home &amp; Garden
                                    </a>
                                    <ul class="megamenu">
                                        <li>
                                            <h4 class="menu-title">Bedroom</h4>
                                            <hr class="divider" />
                                            <ul>
                                                <li><a href="shop-fullwidth-banner.html">Beds, Frames &amp; Bases</a>
                                                </li>
                                                <li><a href="shop-fullwidth-banner.html">Dressers</a></li>
                                ...
                                <li class="has-submenu">
                                    <a href="shop-fullwidth-banner.html"> <i class="w-icon-electronics"></i>Electronics
                                    </a>
                                    <ul class="megamenu">
                                        <li>
                                            <h4 class="menu-title">Laptops &amp; Computers</h4>
                                ...
                                <li>
                                    <a href="shop-fullwidth-banner.html"> <i class="w-icon-heartbeat"></i>Healthy &amp;
                                        Beauty
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="shop-fullwidth-banner.html"> <i class="w-icon-gamepad"></i>Toy &amp; Games
                                    </a>
                                </li>
                                <li>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="banner-content y-50 text-right">
                                                ...
                                                <p class="font-weight-normal text-default slide-animate"
                                                    ...
                                                    Sale up to <span class="font-weight-bolder text-secondary">30%
                                                        OFF</span>
                                                </p>
                                                                ...
                                                                <form id="add_to_cart" method="post">
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <div class="product-qty-form mt-2">
                                                                            <div class="d-flex justify-content-between">
                                                                                <a
                                                                                    class="quantity-minus w-icon-minus"></a>
                                                                                <input name="product_qty"
                                                                                    class="quantity form-control"
                                                                                    type="number" min="1" max="100"
                                                                                    value="1">
                                                                                <a
                                                                                    class="quantity-plus w-icon-plus"></a>
                                                                            </div>
                                                                        </div>
                                                                        <button type="submit"
                                        ...
                                        <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                            ...
                                            <div class="swiper-slide product-widget-wrap">
                                                ...
                                                if($ever<=0){ $evrating='0%' ; } elseif($ever<=1){ $evrating='20%' ; }
                                                    ...
                                                    ($ever<=5) { $evrating='100%' ; } if ($product->
                                                    sell_price) {
                                                    $price = '<ins class="new-price">৳ '.$product->sell_price.'</ins>
                                                    <del class="old-price">৳ '.$product->price.'</del>';
                                                    } else {
                                                ...
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div class="product-price"><ins
                                                                class="new-price">$135.60</ins><del
                                            ...
                                            <div class="swiper-slide product-widget-wrap">
                                                ...
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div class="product-price"><ins
                                                                class="new-price">$243.30</ins><del
                                                ...
                                                <div class="product product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div class="product-price"><ins
                                                                class="new-price">$450.68</ins><del
                            ...
                            <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                                ...
                                <div
                                    ...
                                    <a href="{{ url('/category') }}/{{ $cat1->slug }}" class=" category-media cat_btn"
                                        cat1_slug="{{ $cat1->slug }}">
                                        <img src="{{asset('')}}storage/categories/{{ $cat1->photo }}" alt="Category"
    ...
    <div class="compare-popup">
        <div class="container">
            ...
            <ul class="compare-product-list list-style-none">
                ...
                <li></li>
                <li></li>
            </ul> <a href="#" class="btn btn-clean">Clean All</a> <a href="compare.html"
                class="btn btn-dark btn-rounded">Start Compare !</a>
        </div>
    </div>
    ...
    <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button"> <i class="w-icon-angle-up"></i> <svg
            ...
            <circle id="progress-indicator" fill="transparent" stroke="#000000" stroke-miterlimit="10" cx="35" cy="35"
                r="34" style="stroke-dasharray: 25.235, 400;"></circle>
        </svg> </a>
    <!-- End of Scroll Top -->
                    ...
                    <ul class="mobile-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.portotheme.com/html/wolmart/blog-grid.html">Grid<span
                                            class="toggle-btn"></span></a>
                                    <ul>
            ...
            <div class="col-md-6 mb-4 mb-md-0">
                <div class="product-gallery product-gallery-sticky">
                    <div
                        ...
                        <div class="swiper-wrapper " id="swiper-wrapper-0a956f35d4a58d15" aria-live="polite"
                        ...
                        <button class="swiper-button-next" tabindex="0" aria-label="Next slide"
                            aria-controls="swiper-wrapper-0a956f35d4a58d15" aria-disabled="false"></button>
                        <button class="swiper-button-prev" tabindex="0" aria-label="Previous slide"
                            aria-controls="swiper-wrapper-0a956f35d4a58d15" aria-disabled="false"></button>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                    </div>
                    <div class="product-thumbs-wrap swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-free-mode"
                        data-swiper-options="{
                        'navigation': {
                        ...
                        <div class="product-thumbs swiper-wrapper   " id="swiper-wrapper-e631329465590ff6"
                        ...
                        <button class="swiper-button-next" tabindex="0" aria-label="Next slide"
                            aria-controls="swiper-wrapper-e631329465590ff6" aria-disabled="false"></button>
                        <button class="swiper-button-prev" tabindex="0" aria-label="Previous slide"
                            aria-controls="swiper-wrapper-e631329465590ff6" aria-disabled="false"></button>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                    </div>
...
<!-- Mirrored from portotheme.com/html/wolmart/shop-banner-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jan 2022 07:32:48 GMT -->
