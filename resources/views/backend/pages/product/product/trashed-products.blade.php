            ...
            <div class="card">
                <div class="card-body">
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title mb-3 bg-danger p-2 d-block">
                                <h3 class="">TRASHED PRODUCTS<a href="{{ route('product.index') }}"
                                        class="badge bg-success mx-2" style="font-size: 12px;">Active products</a></h3>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table id="trashed_products_table"
