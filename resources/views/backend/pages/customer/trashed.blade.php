        ...
        <div class="card">
            <div class="card-body">
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h3 class="m-0">Trashed customers<a href="{{ route('admin.customer.index') }}"
                                    class="badge bg-success mx-2" style="font-size: 12px;">All customers</a></h3>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="trashed_customer_table"
