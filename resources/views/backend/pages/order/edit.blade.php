                            ...
                            <div class="order-summary">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-name">{{ $cart->name }} (৳ {{ $cart->price }}<i
                                                    class="fas fa-times"></i> <span class="product-quantity">{{
                                                    $cart->qty }}</span>)</td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b>{{ $order->shippingMethod->title }}</b>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('/admin/order/billing/update') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label>Zilla *</label>
                                                <input type="text" class="form-control form-control-md" name="zilla"
                                                    value="{{ $order->customer_zilla }}" />
                                            </div>
                                            @error('zilla')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <div class="row gutter-sm">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-md"
                                                            name="thana" value="{{ $order->customer_thana }}" />
                                                    </div>
                                                    @error('thana')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label>Post *</label>
                                                        <input type="text" class="form-control form-control-md"
                                                            name="post" value="{{ $order->customer_post }}" />
                                                    </div>
                                                    @error('post')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                            ...
                                            <div class="row gutter-sm">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label>Village *</label>
                                                        <input type="text" class="form-control form-control-md"
                                                            name="village" value="{{ $order->customer_vill }}" />
                                                    </div>
                                                    @error('village')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-md"
                                                            name="post_code" value="{{ $order->customer_post_code }}" />
                                                    </div>
                                                    @error('post_code')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-md"
                                                        name="pickup_location" value="{{ $order->pickup_location }}" />
                                                </div>
                                            ...
                                            <div class="form-group place-order pt-6 mt-2">
                                                <button type="submit" class="btn btn-dark btn-rounded">Save
                                                    change</button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('/admin/order/shipping/update') }}" method="POST">
                                            ...
                                            <div class="form-group mb-2">
                                                <label>Name *</label>
                                                <input type="text" class="form-control form-control-md" name="name2"
                                            ...
                                            <div class="form-group">
                                                <label>Zilla *</label>
                                                <input type="text" class="form-control form-control-md" name="zilla2"
                                                    value="{{ $order->shipping_zilla }}" />
                                            </div>
                                            @error('zilla2')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <div class="row gutter-sm">
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label>Thana *</label>
                                                        <input type="text" class="form-control form-control-md"
                                                            name="thana2" value="{{ $order->shipping_thana }}" />
                                                    </div>
                                                    @error('thana2')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label>Post *</label>
                                                        <input type="text" class="form-control form-control-md"
                                                            name="post2" value="{{ $order->shipping_post }}" />
                                                    </div>
                                                    @error('post2')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                            ...
                                            <div class="row gutter-sm">
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-md"
                                                            name="post_code2"
                                                            value="{{ $order->shipping_post_code }}" />
                                                    </div>
                                                    @error('post_code2')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    <label>Pickup location *</label>
                                                    <input type="text" class="form-control form-control-md"
                                                        name="pickup_location2" value="{{ $order->pickup_location }}" />
                                                </div>
